...
def main():
    ...
    parser.add_argument("-d", "--days",       type=int, default=10,       help="Number of days ago to start collect AWR data (default 10, max 999)")
    parser.add_argument(      "--offset",     type=int, default=0,        help="Number of days ago to end  AWR collect period, default 0, max 999")
